...
HD_PWD='C:/dev/fpga_proj/_mini/manoCPU/_ref/lab13_new/bram_axi_project/bram_axi_project.runs/design_1_bram_axi_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_bram_axi_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_bram_axi_0_0.tcl
