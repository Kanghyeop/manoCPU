...
HD_PWD='C:/dev/fpga_proj/_mini/manoCPU/_ref/lab16_new/data_mover_bram_lab_project/data_mover_bram_lab_project.runs/design_1_lab16_matbi_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_lab16_matbi_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_lab16_matbi_0_0.tcl
