...
HD_PWD='C:/dev/fpga_proj/_mini/manoCPU/_ref/lab16_new/data_mover_bram_lab_project/data_mover_bram_lab_project.runs/design_1_processing_system7_0_0_synth_1'
cd "$HD_PWD"
