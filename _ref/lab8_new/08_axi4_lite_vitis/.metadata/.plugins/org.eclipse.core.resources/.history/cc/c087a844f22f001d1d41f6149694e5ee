...
// Modified Code for Ver 2021.1
	Xil_Out32((XPAR_MYIP_0_S00_AXI_BASEADDR) + (0*AXI_DATA_BYTE), 1);
	Xil_Out32((XPAR_MYIP_0_S00_AXI_BASEADDR) + (1*AXI_DATA_BYTE), 2);
	Xil_Out32((XPAR_MYIP_0_S00_AXI_BASEADDR) + (2*AXI_DATA_BYTE), 3);
	Xil_Out32((XPAR_MYIP_0_S00_AXI_BASEADDR) + (3*AXI_DATA_BYTE), 4);

	data[0] = Xil_In32((XPAR_MYIP_0_S00_AXI_BASEADDR) + (0*AXI_DATA_BYTE));
	data[1] = Xil_In32((XPAR_MYIP_0_S00_AXI_BASEADDR) + (1*AXI_DATA_BYTE));
	data[2] = Xil_In32((XPAR_MYIP_0_S00_AXI_BASEADDR) + (2*AXI_DATA_BYTE));
	data[3] = Xil_In32((XPAR_MYIP_0_S00_AXI_BASEADDR) + (3*AXI_DATA_BYTE));
